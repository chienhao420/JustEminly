    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://raw.githubusercontent.com/chienhao420/blog-back-up1/master/min_photos/' + data.link[i];
          var src = 'https://raw.githubusercontent.com/chienhao420/Blog-Back-Up1/master/photos/' + data.link[i];
